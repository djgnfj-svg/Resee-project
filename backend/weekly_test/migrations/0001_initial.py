# Generated by Django 4.2.16 on 2025-09-27 06:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('content', '0009_alter_content_title'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', '대기중'), ('in_progress', '진행중'), ('completed', '완료')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_type', models.CharField(choices=[('multiple_choice', '객관식'), ('subjective', '주관식'), ('true_false', 'O/X')], default='multiple_choice', max_length=20)),
