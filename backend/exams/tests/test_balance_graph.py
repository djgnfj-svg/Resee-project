...
class TestWeeklyTestBalanceGraph(TestCase):
    ...
    def setUp(self):
        ...
        # 카테고리 생성
        self.category = Category.objects.create(name="테스트 카테고리", user=self.user)
    ...
    def test_balance_graph_integration(self):
        ...
        result = select_balanced_contents_for_test(
            contents=content_data, target_count=10
        )
    ...
    def test_insufficient_contents(self):
        ...
        result = select_balanced_contents_for_test(
            contents=content_data, target_count=10  # 10개 요청하지만 5개만 있음
        )
