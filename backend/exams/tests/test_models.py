...
class WeeklyTestModelTest(TestCase):
    ...
    def test_weekly_test_calculate_score_with_questions(self):
        ...
        test = WeeklyTest.objects.create(
            user=self.user, total_questions=10, correct_answers=7
        )
    ...
    def test_weekly_test_calculate_score_zero_questions(self):
        ...
        test = WeeklyTest.objects.create(
            user=self.user, total_questions=0, correct_answers=0
        )
    ...
    def test_weekly_test_str(self):
        ...
        expected = (
            f"{self.user.email} - Test Title ({today} ~ {today + timedelta(days=7)})"
        )
    ...
    def test_weekly_test_unique_together(self):
        ...
        WeeklyTest.objects.create(user=self.user, start_date=today, end_date=end)
    ...
    def test_weekly_test_different_user_same_dates(self):
        ...
        test1 = WeeklyTest.objects.create(
            user=self.user, start_date=today, end_date=end
        )
        test2 = WeeklyTest.objects.create(user=user2, start_date=today, end_date=end)
...
class WeeklyTestQuestionModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.weekly_test = WeeklyTest.objects.create(user=self.user, title="Test Week")
...
class WeeklyTestAnswerModelTest(TestCase):
    ...
    def test_answer_creation(self):
        ...
        answer = WeeklyTestAnswer.objects.create(
            question=self.question, user=self.user, user_answer="4"
        )
    ...
    def test_answer_auto_grading_incorrect(self):
        ...
        answer = WeeklyTestAnswer.objects.create(
            question=self.question, user=self.user, user_answer="5"
        )
    ...
    def test_answer_case_insensitive_comparison(self):
        ...
        answer1 = WeeklyTestAnswer.objects.create(
            question=self.question, user=self.user, user_answer="python"
        )
        ...
        answer2 = WeeklyTestAnswer.objects.create(
            question=self.question, user=user2, user_answer="PYTHON"
        )
