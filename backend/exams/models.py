...
class WeeklyTest(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="weekly_tests"
    )
...
class WeeklyTestQuestion(models.Model):
    ...
    content = models.ForeignKey(
        Content, on_delete=models.CASCADE, related_name="test_questions"
    )
...
class WeeklyTestAnswer(models.Model):
    ...
    question = models.ForeignKey(
        WeeklyTestQuestion, on_delete=models.CASCADE, related_name="answers"
    )
