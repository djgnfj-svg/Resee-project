...
class CategoryModelTest(TestCase):
    ...
    def test_category_creation(self):
        ...
        category = Category.objects.create(
            name="Python", description="Python programming", user=self.user
        )
    ...
    def test_category_slug_auto_generation(self):
        ...
        category = Category.objects.create(name="Python Basics", user=self.user)
    ...
    def test_category_str(self):
        ...
        category = Category.objects.create(name="Django", user=self.user)
...
class ContentModelTest(TestCase):
    ...
    def test_content_empty_title_validation(self):
        ...
        content = Content(title="", content="Some content", author=self.user)
        with self.assertRaises(ValidationError):
            content.save()
    ...
    def test_content_empty_content_validation(self):
        ...
        content = Content(title="Test", content="", author=self.user)
        with self.assertRaises(ValidationError):
            content.save()
    ...
    def test_content_original_values_tracking(self):
        ...
        content = Content.objects.create(
            title="Original Title", content="Original content", author=self.user
        )
