...
class CustomUserAdmin(UserAdmin):
    ...
    def subscription_tier(self, obj):
        ...
        if hasattr(obj, "subscription") and obj.subscription:
            ...
            colors = {"free": "#6c757d", "basic": "#007bff", "pro": "#28a745"}
    ...
    def bulk_verify_email(self, request, queryset):
        ...
        self.message_user(
            request, f"Successfully verified {updated} user emails.", messages.SUCCESS
        )
...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("user", "tier", "max_interval_days")}),
        ("Subscription Period", {"fields": ("start_date", "end_date", "is_active")}),
        (
            "Timestamps",
