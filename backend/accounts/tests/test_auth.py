...
class EmailTokenObtainPairViewTest(TestCase):
    ...
    def test_login_missing_email(self):
        ...
        response = self.client.post("/api/auth/token/", {"password": "testpass123"})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)

    def test_login_missing_password(self):
        """Test login without password field."""
        response = self.client.post("/api/auth/token/", {"email": "test@example.com"})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
...
class UserMeEndpointTest(TestCase):
    ...
    def test_delete_account_success(self):
        ...
        response = self.client.delete(
            ...
            {"password": "testpass123", "confirmation": "DELETE"},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_account_wrong_password(self):
        ...
        response = self.client.delete(
            "/api/accounts/users/me/",
            {"password": "wrongpass", "confirmation": "DELETE"},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_delete_account_wrong_confirmation(self):
        ...
        response = self.client.delete(
            "/api/accounts/users/me/",
            {"password": "testpass123", "confirmation": "WRONG"},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_delete_account_missing_fields(self):
        ...
        response = self.client.delete(
            "/api/accounts/users/me/", {"password": "testpass123"}, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
