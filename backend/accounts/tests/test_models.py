...
class SubscriptionModelTest(TestCase):
    ...
    def test_subscription_str(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, tier=SubscriptionTier.PRO
        )
    ...
    def test_is_expired_without_end_date(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, tier=SubscriptionTier.PRO, end_date=None
        )
    ...
    def test_is_expired_with_future_end_date(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, tier=SubscriptionTier.PRO, end_date=future_date
        )
        self.assertFalse(subscription.is_expired())
    ...
    def test_is_expired_with_past_end_date(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, tier=SubscriptionTier.PRO, end_date=past_date
        )
    ...
    def test_save_sets_max_interval_days_for_free(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, tier=SubscriptionTier.FREE
        )
    ...
    def test_save_sets_max_interval_days_for_basic(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, tier=SubscriptionTier.BASIC
        )
...
class NotificationPreferenceModelTest(TestCase):
    ...
    def test_default_values(self):
        ...
        self.assertTrue(
            created or pref.email_notifications_enabled
        )  # Either newly created or has default
