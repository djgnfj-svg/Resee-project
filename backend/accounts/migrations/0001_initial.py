    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "weekly_goal",
                    models.IntegerField(default=7, help_text="주간 복습 목표 횟수"),
                ),
                (
                    "terms_agreed_at",
                    models.DateTimeField(
                        blank=True, help_text="이용약관 동의 일시", null=True
                    ),
                ),
                (
                    "privacy_agreed_at",
                    models.DateTimeField(
                        blank=True, help_text="개인정보처리방침 동의 일시", null=True
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.CharField(
                        default="1.0", help_text="문서 버전", max_length=20
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "next_billing_date",
                    models.DateTimeField(
                        blank=True, help_text="Next automatic billing date", null=True
                    ),
                ),
                (
                    "payment_method",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "daily_reminder_time",
                    models.TimeField(default="09:00", help_text="일일 복습 알림 시간"),
                ),
                (
                ...
                (
                    "weekly_summary_time",
                    models.TimeField(default="09:00", help_text="주간 요약 발송 시간"),
                ),
                (
                    "unsubscribe_token",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_path",
                    models.CharField(
                        blank=True, help_text="생성된 파일 경로", max_length=500
                    ),
                ),
                (
                    "expires_at",
                    models.DateTimeField(
                        blank=True, help_text="다운로드 링크 만료일", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session_id",
                    models.CharField(help_text="세션 ID (비회원용)", max_length=100),
                ),
                (
                    "essential_cookies",
                    models.BooleanField(
                        default=True, help_text="필수 쿠키 (항상 허용)"
                    ),
                ),
                (
                    "analytics_cookies",
                    models.BooleanField(default=False, help_text="분석 쿠키"),
                ),
                (
                    "marketing_cookies",
                    models.BooleanField(default=False, help_text="마케팅 쿠키"),
                ),
                (
                    "functional_cookies",
                    models.BooleanField(default=False, help_text="기능 쿠키"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_version",
                    models.CharField(help_text="동의한 문서 버전", max_length=20),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="accounts_pa_user_id_ad9a67_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scheduled_date",
                    models.DateTimeField(help_text="Date when billing should occur"),
                ),
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, help_text="Amount to be billed", max_digits=10
                    ),
                ),
                (
                    "billing_cycle",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="accounts_bi_subscri_b8a9c1_idx",
                    ),
                    models.Index(
                        fields=["status", "scheduled_date"],
                        name="accounts_bi_status_be1391_idx",
                    ),
                ],
            },
        ),
