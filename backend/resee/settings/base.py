...
try:
    EMAIL_VERIFICATION_TIMEOUT_DAYS = int(
        os.environ.get("EMAIL_VERIFICATION_TIMEOUT_DAYS", 1)
    )
...
ALERT_SUMMARY_RECIPIENTS = (
    os.environ.get("ALERT_SUMMARY_RECIPIENTS", "").split(",")
    if os.environ.get("ALERT_SUMMARY_RECIPIENTS")
    else []
)
...
TOSS_SUCCESS_URL = os.environ.get(
    "TOSS_SUCCESS_URL", "http://localhost/payment/success"
)
