...
def health_check(request):
    ...
    try:
        ...
        slack_notifier.send_health_alert(
            service="database", status="down", details=f"Health check failed: {str(e)}"
        )
...
def detailed_health_check(request):
    ...
    """
    health_status = {"status": "ok", "timestamp": None, "services": {}}
    ...
    try:
        ...
        # Send Slack alert
        slack_notifier.send_health_alert(
            service="database", status="down", details=str(e)
        )
    ...
    try:
        ...
        # Send Slack alert
        slack_notifier.send_health_alert(service="redis", status="down", details=str(e))
    ...
    try:
        ...
        # Send Slack alert
        slack_notifier.send_health_alert(
            service="celery", status="down", details=str(e)
        )
...
def test_slack_notification(request):
    ...
    message = request.GET.get(
        "message", "This is a test notification from Resee monitoring system"
    )
