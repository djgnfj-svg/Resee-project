...
const ReviewPage: React.FC = () => {
  ...
  // Only card mode available now
  const [reviewMode, setReviewMode] = useState<'card'>('card');
        ...
        <div className="flex flex-col md:flex-row md:items-end md:space-x-6 space-y-4 md:space-y-0">
          ...
          <div className="flex-1 max-w-md">
            ...
            <div className="flex rounded-md shadow-sm" role="group">
              <button
                type="button"
                className="px-4 py-2 text-sm font-medium rounded-md border bg-blue-600 dark:bg-blue-500 text-white border-blue-600 dark:border-blue-500"
              >
                🃏 카드 모드
              </button>
            </div>
