...
export const authAPI = {
  ...
  changePassword: async (data: {
    ...
    const response = await apiClient.put('/accounts/users/me/password/', data);
    return response.data;
  },
  ...
  deleteAccount: async (data: {
    ...
    const response = await apiClient.delete('/accounts/users/me/', { data });
    return response.data;
  },
  ...
  updateWeeklyGoal: async (
    weeklyGoal: number
  ): Promise<{ message: string; weekly_goal: number }> => {
    const response = await apiClient.patch('/accounts/weekly-goal/', {
